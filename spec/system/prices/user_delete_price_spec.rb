describe 'Usuário apaga um preço de temporada' do
    it 'com sucesso' do
        ...
        click_on 'Quartos'
        click_on 'Detalhes'
        click_on 'Ver precificação'
        click_on 'Apagar'

                        
        expect(page).to have_content('Precificação removida com sucesso.')
        expect(page).not_to have_content('Novo preço: R$ 230,00')
        expect(page).not_to have_content('Datas: Entre: 02/02/2023 até 05/02/2023')
    end
