...
describe 'Guest cancela a reserva' do
    ...
    it 'mas dá errado pois a reserva começa em menos de 7 dias' do
        ...
        Reservation.create!(guest_number: guest.id, start_date: Date.today, final_date: 7.day.from_now, room_id: room_one.id,  guest_id: guest.id, total_price: 400)
        Reservation.create!(guest_number: guest.id, start_date: Date.today, final_date: 7.day.from_now, room_id: room_two.id,  guest_id: guest.id, total_price: 300)
