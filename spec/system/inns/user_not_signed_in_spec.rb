...
describe 'Usuário visita tela inicial de Pousada sem estar logado' do
    it 'e vê listagem de pousadas' do
        ...
        Price.create!(new_rate: 290, start_date: '2023-02-01', final_date: '2023-02-02', room_id: room_two.id)   
        ...
        Price.create!(new_rate: 230, start_date: '2022-02-02', final_date: '2022-02-05', room_id: room_three.id)
