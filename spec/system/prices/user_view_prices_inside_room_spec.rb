...
describe 'Usuário visita página de quartos e ve preços' do
    it 'com sucesso' do
        ...
        expect(page).to have_content('Quarto Pokémon')
        expect(page).to have_content('Preços por período:')
        expect(page).to have_content('Novo preço: R$ 230')
        expect(page).to have_content('Entre: 02/02/2023 até 05/02/2023')
