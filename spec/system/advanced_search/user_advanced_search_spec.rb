...
describe 'Usuário busca por uma pousada' do
    it 'a partir do menu' do
        ...
        Room.create!(name: 'Quarto Pokémon', description: 'Descrição: Quarto idêntico ao quarto de Ash.', size: 20, guest: 2, daily_rate: 20, balcony: 'possui', air_conditioner: 'possui ar condicionado', available: 'sim', tv: 'não possui tv', wardrobe: 'possui guarda-roupas', safe: 'possui cofre', accessible: 'quarto com acessibilidade', inn_id: inn.id)
        ...
        Room.create!(name: 'Quarto Zelda', description: 'Descrição: Quarto baseando em Hyrule.', size: 30, guest: 3, daily_rate: 30, balcony: 'não possui', air_conditioner: 'não possui ar condicionado', available: 'sim', tv: 'não possui tv', wardrobe: 'não possui guarda-roupas', safe: 'não possui cofre', accessible: 'quarto sem acessibilidade', inn_id: inn_two.id)
        ...
        Room.create!(name: 'Quarto Bianca', description: 'Quarto idêntico ao da Bianca.', size: 40, guest: 4, daily_rate: 40, balcony: 'possui', air_conditioner: 'não possui ar condicionado', available: 'sim', tv: 'não possui tv', wardrobe: 'possui guarda-roupas', safe: 'possui cofre', accessible: 'quarto sem acessibilidade', inn_id: inn_three.id)

        user_four = Owner.create!(name: 'Isabel', last_name: 'Lopes', email: 'isabel@pousadaria.com', password: 'password')
        inn_four = Inn.create!(trade_name: 'Pousada da Isa', company_name: 'Pousada da Isabel LTDA', registration_number: '32999227839', phone: '32999227839-2345', email: 'contato@daisa.com', address: 'Rua das Couves, 10', neighborhood: 'Pinheiros', city: 'São Paulo', zip_code: '389434-923', description: 'A segunda melhor Pousada do mundo.', payment_methods: 'Apenas PIX', pet: 'não permitidos', rules: 'Não pode ouvir música alta.', check_in: '12:00', check_out: '14:00', status: "ativa", owner_id: user_four.id)
        Room.create!(name: 'Quarto Isabel', description: 'Quarto da Isabel.', size: 50, guest: 5, daily_rate: 50, balcony: 'não possui', air_conditioner: 'não possui ar condicionado', available: 'sim', tv: 'não possui tv', wardrobe: 'não possui guarda-roupas', safe: 'não possui cofre', accessible: 'quarto sem acessibilidade', inn_id: inn_four.id)
